              ...
              <div class="col-lg-6">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select id="apartment_id"   class="form-control @error('apartment_id') is-invalid @enderror" name="apartment_id" value="{{ old('apartment_id') }}" required autocomplete="apartment_id" autofocus>
